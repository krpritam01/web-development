...
// For example, if the input to the function is "Mithun", the promise should resolve with the string "Hello, Mithunt"
...
greet("Pritam").then((message) => console.log(message))
